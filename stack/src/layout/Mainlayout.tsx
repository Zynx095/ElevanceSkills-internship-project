...
const Mainlayout = ({ children }: MainlayoutProps) => {
  ...
  return (
    ...
    <div className="relative min-h-screen bg-[#050505] text-gray-200 font-sans selection:bg-purple-500/30 overflow-hidden">
      ...
      <div className="relative z-10 flex max-w-[1440px] mx-auto pt-16 lg:pt-0 h-[calc(100vh-64px)]">

        {/* Desktop Sidebar */}
        <Sidebar isopen={sidebarOpen} />

        {/* Main Content */}
        <main className="flex-1 min-w-0 overflow-y-auto px-4 py-5 pb-24 sm:px-5 lg:px-8 lg:py-8 lg:pb-8 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
          {children}
        </main>

        {/* Desktop Right Sidebar */}
        <aside className="hidden xl:flex w-80 border-l border-white/5 bg-transparent overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
          <RightSideBar />
        </aside>
